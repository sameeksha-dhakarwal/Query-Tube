...
Rows after filtering: ${data.rows_after_filtering}
Vectors stored: ${data.vectors_stored}`
        );
      }
    } catch {
  ...
  // ===============================
  return (
    <div className="app-container" style={{ padding: "40px", maxWidth: "900px", margin: "auto" }}>
      <h1>🎥 QueryTube</h1>
